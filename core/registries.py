...
class Plugin(APIUrlsInstanceMixin, Instance):
    ...
    Example:
        ...
        from core.registries import Plugin, plugin_registry
...
class PluginRegistry(APIUrlsRegistryMixin, Registry):
    ...
    abstraction made specifically for  It allows a plugin developer to
...
class ApplicationType(
    ...
    Example:
        ...
        from core.registries import ApplicationType, application_type_registry
...
class ApplicationTypeRegistry(APIUrlsRegistryMixin, ModelRegistryMixin, Registry):
    ...
    application is an abstraction made specifically for  If added to the
...
# used throughout the whole stockcnn application. To add a new plugin or application use
# these registries.
